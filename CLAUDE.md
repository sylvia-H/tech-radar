...
3. **只推變化、控制節奏（III）**：榜單**每七天推一次且只呈現差異**（`lastBoardPushAt` 計時，非
   cron；到期門檻 **162h** = 168h − 6h 寬限）；新聞**每日固定精選至多 10 則**（AI ≥ 7；DevOps/後端/
   前端合計 ≤ 3，寧缺勿濫；2026-07-19 由 6 則 / AI≥4 / 非AI≤2 調整為 10 則 / AI≥5 / 非AI≤3，
   2026-07-29 AI 下限再調整為 ≥7，見 dev-guide §4.4）；字數上限
