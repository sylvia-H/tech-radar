...
內容本身是否重要：
- 算重大、應收錄：
  (1) 官方發布新模型／新工具／新版本或重大能力更新（即使只是一篇官方 blog 宣布、沒有大篇幅
      報導也算數）、breaking change、安全通報、標準變動、重大 deprecation。
  (2) 來自 Hacker News / Lobste.rs / Reddit 等高信度社群、分數或討論熱度異常高的任何形式內容
    （包括觀點文、評論、討論串）——社群熱度本身就是「開發者關注度」的訊號，反映現在業界在
      熱烈討論什麼、思想風向如何。
- 不算重大、不應收錄：
